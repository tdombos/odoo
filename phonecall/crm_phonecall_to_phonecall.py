...
class crm_phonecall2phonecall(osv.osv_memory):
    _name = 'phonecall.phonecall2phonecall'
    ...
    def action_schedule(self, cr, uid, ids, context=None):
        ...
        if context is None:
            context = {}
        phonecall = self.pool.get('phonecall.phonecall')
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if record_id:
            phonecall = self.pool.get('phonecall.phonecall').browse(cr, uid, record_id, context=context)
